...
"""
    g1 = [str(i) for i in range(1, edn+1)]
    g2 = [str(i) for i in range(edn+1, edn+lin+1)]
    g1 = str.join(' ', g1)
    g2 = str.join(' ', g2)
...
"""
    ...
    data += """
    LINESTYLE -
    EDGECOLOUR 197 140 133

AXISPROPS
    LIMITS -0.8 0.6 -0.7 0.7
...
"""
    ...
    with open('trial_code2.dat', 'w') as file:
        file.write(data)
